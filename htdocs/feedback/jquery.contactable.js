	...
	jQuery.fn.contactable = function(options) {
		...
		return this.each(function() {
			...
			// Toggle the form visibility
   			...
   			jQuery('#contactable_inner_close').click(function() {
			...
			jQuery('#contactable_inner').toggleClick(function() {
				...
				jQuery('#contactable #captcha_img').attr("src", options.base + "captcha/captcha.php?SESSID="+ feedback_sessionid+'&_='+Date.now());
