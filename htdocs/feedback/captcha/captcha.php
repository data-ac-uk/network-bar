...
$captcha->scale = 3; $captcha->blur = false;
//$captcha->resourcesPath = "/var/cool-php-captcha/resources";
$captcha->colors = array(array(51,51,51));
...
class SimpleCaptcha {
     ...
     */
    public $fonts = array(
        'Antykwa'  => array('spacing' => -2, 'minSize' => 27, 'maxSize' => 30, 'font' => 'AntykwaBold.ttf'),
    ...
    protected function ReduceImage() {
        ...
        $imResampled = imagecreatetruecolor($this->fwidth, $this->fheight);
